...
export function defaultProcedureText(organizationName: string): string {
  return `${organizationName} holds a management review of the ISMS at least annually, and additionally after any major incident or significant change. The review is chaired by top management, considers the inputs required by ISO 27001 Clause 9.3.2, and records the outputs required by Clause 9.3.3. Minutes are retained in Dilligent.`;
}
...
export const SEED_REVIEW_INPUT_DEFINITIONS: SeedReviewInputDefinition[] = [
  ...
  },
  {
    ...
    whereToFind:
      'Dilligent > ISMS > Documents > Interested Parties Register & Interested Parties Requirements',
  },
  {
    ...
    whereToFind: 'Dilligent > Findings',
  },
  {
  ...
  },
  {
    ...
    whereToFind: 'Dilligent > ISMS > Internal Audit',
  },
  {
    ...
    whereToFind:
      'Dilligent > ISMS > Documents > Information Security Objectives and Plan',
  },
  {
    ...
    whereToFind: 'Dilligent > Vendors (reviews) + external channels',
  },
  {
  ...
  },
  {
    ...
    whereToFind: 'Dilligent > Findings (tagged OFI) + ideas raised at this meeting',
  },
];
