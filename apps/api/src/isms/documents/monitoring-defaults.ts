...
export const SEED_METRIC_DEFINITIONS: SeedMetricDefinition[] = [
  {
    ...
    method:
      'Dilligent training tracker: completed assignments over total assigned, per campaign with monthly follow-up.',
    cadence: 'monthly',
  ...
  },
  {
    ...
    method:
      'Dilligent vendor register: critical vendors with a review inside its window and a signed DPA, over all critical vendors.',
    cadence: 'quarterly',
  ...
  },
  {
    ...
    method:
      'Corrective-action records in Dilligent: open findings and days since each was raised, against its due date.',
    cadence: 'monthly',
  ...
  },
  {
    ...
    method:
      'Dilligent risk register: risks by treatment status, highlighting high and critical risks without an active plan.',
    cadence: 'quarterly',
  ...
  },
  {
    ...
    method:
      'Dilligent policy tracker: members with all assigned policies acknowledged, over all members with assignments.',
    cadence: 'quarterly',
