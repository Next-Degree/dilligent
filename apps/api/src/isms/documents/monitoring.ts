...
export function buildMonitoringSections(
  ...
  return [
    ...
    },
    {
      ...
      intro:
        'For each metric the framework records what is measured, the method, the cadence, who monitors, who analyses, the target, and the current (most recent) value — as required by Clause 9.1(a)–(f). Measurement history is retained in Dilligent per metric and is exportable to CSV for auditor sampling.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        {
          text: 'Measurement results, analysis, and evaluation are retained as documented information in Dilligent to provide evidence of monitoring and to support audit sampling. Each measurement records the period it covers, the value, who entered it, and an immutable "recorded on" date.',
        },
      ],
    },
    {
