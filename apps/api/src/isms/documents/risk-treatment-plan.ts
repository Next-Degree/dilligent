  ...
  return [
    {
      ...
      paragraphs: [
        ...
        {
          text: 'The plan is rendered from the Risk Register and the Vendors module in Dilligent and reflects the state of the register at the time of rendering. It is regenerated on demand; any material change to the register after this document was approved is flagged in Dilligent so the plan can be refreshed.',
        },
      ],
    },
    {
