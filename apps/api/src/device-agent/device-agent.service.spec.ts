...
describe('DeviceAgentService', () => {
  ...
  beforeAll(() => {
    process.env.DEVICE_AGENT_S3_BUCKET = 'test-bucket';
    process.env.DEVICE_AGENT_S3_ENDPOINT = 'https://branch.storage.example.com';
    process.env.DEVICE_AGENT_S3_REGION = 'us-east-2';
    process.env.DEVICE_AGENT_S3_ACCESS_KEY_ID = 'test-key';
    process.env.DEVICE_AGENT_S3_SECRET_ACCESS_KEY = 'test-secret';
    process.env.DEVICE_AGENT_S3_ENV = 'production';
  });
