...
function mockTx() {
  return {
    ...
    frameworkControlFamily: { create: jest.fn().mockResolvedValue({ id: 'fcf_new' }), findUnique: jest.fn().mockResolvedValue(null), upsert: jest.fn().mockResolvedValue({ id: 'fcf_new' }), deleteMany: jest.fn().mockResolvedValue({ count: 0 }) },
