  ...
  return (
    <SettingGroup>
      <SettingRow
        ...
        description="Employees will be asked to download and install Dilligent's device agent on their device."
      >
        <Switch
      ...
      <SettingRow
        ...
        description="Employees will be required to complete Dilligent's security awareness training videos."
      >
        <Switch
