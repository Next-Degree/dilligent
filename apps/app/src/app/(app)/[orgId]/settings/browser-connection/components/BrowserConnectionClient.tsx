        ...
        <div className="rounded-lg border border-border bg-muted/30 p-3.5">
          ...
          <ol className="flex flex-col gap-1.5 text-[12px] leading-relaxed text-muted-foreground">
            <li className="flex gap-1.5">
              ...
              <span>
                Connect a vendor login here — Dilligent signs in for you, including any
                two-factor codes.
              </span>
            </li>
            <li className="flex gap-1.5">
          ...
          <div className="flex flex-wrap items-start gap-3 rounded-lg border border-border bg-primary/[0.04] p-3.5">
            ...
            <div className="min-w-0 flex-1 basis-[260px]">
              ...
              <div className="mt-0.5 text-[12px] leading-relaxed text-muted-foreground">
                Add an authenticator setup key and Dilligent generates the 6-digit code at
        ...
        <div className="grid place-items-center rounded-lg border border-dashed border-border py-16 text-center">
          <div className="max-w-[320px]">
            ...
            <p className="mt-1 text-[12.5px] text-muted-foreground">
              Connect a vendor login so Dilligent can sign in and capture evidence for your
              browser automations.
            </p>
            {canConnect && (
              <div className="mt-4">
