...
export function UnifiedWorkflowCard({
  ...
  const { automationId: sharedAutomationId } = useSharedChatContext();
  const [isAnimationComplete, setIsAnimationComplete] = useState(false);

  // Prefer the shared chat context's automation id: when an ephemeral ("new")
  // automation is created mid-chat, ChatProvider swaps in the real id there.
  const realAutomationId =
    sharedAutomationId && sharedAutomationId !== 'new' ? sharedAutomationId : automationId;
