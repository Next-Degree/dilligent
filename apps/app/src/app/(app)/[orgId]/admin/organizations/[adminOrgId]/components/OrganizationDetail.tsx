      ...
      <Section title="Platform settings">
        <div className="flex items-start justify-between gap-4 rounded-lg border p-4">
          <div className="flex-1">
            ...
            <Text size="sm" variant="muted">
              For Pickle-operated orgs only. When on, platform admins are treated as real members
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {pendingInternal
                ? 'Platform admins will be treated as real members here — assignable, counted in compliance, and notified. Only enable this for Pickle-operated orgs, never a customer organization.'
