...
## Resulting catalog (50 controls)

| Control | SOC 2 | ISO 27001:2022 | Evidence tasks |
| --- | --- | --- | --- |
| Acceptable Use | C1.1, CC2.2, CC5.1 | A.5.10 | Acceptable Use Acknowledgment |
| Access Rights | CC6.1, CC6.2, CC6.3, PI1.4, PI1.5 | A.5.15, A.5.16, A.5.18 | Employee Access; Access Review Log |
| Asset Inventory | CC6.1, CC6.7 | A.5.9 | Device List; Infrastructure Inventory |
| Authentication Enforcement | CC6.1 | A.5.17 | 2FA; Password Policy Configuration Evidence |
| Backup Management | A1.2 | A.8.13 | Backup logs; Backup Restoration Test |
| Board Oversight | CC1.2 | 5.1 | Board Meetings & Independence |
| Business Continuity & ICT Readiness | A1.2, A1.3 | A.5.29, A.5.30 | Contingency Plan Testing & Revision |
| Change management | CC8.1, PI1.3, PI1.4 | 6.3, A.8.32 | Code Changes |
| Configuration & Patch Management | CC6.8, CC7.1 | A.8.9, A.8.19 | System Patching Evidence |
| Credential Management | CC6.1, CC6.6 | A.5.17, A.8.5 | 2FA; Secure Secrets |
| Customer Communications & Support | CC2.3, PI1.1 | — | Status Page & Release Communications |
| Cybersecurity Insurance | CC9.1 | — | Cyber Insurance Policy Review |
| Data Masking | — | A.8.11, A.8.12 | Data Masking |
...
| Data Retention & Destruction | C1.2, CC6.5 | A.7.10, A.7.14, A.8.10 | Media Sanitization & Disposal Log |
| Disaster Recovery Planning | A1.2, A1.3, CC7.5 | A.8.14 | Planning; App Availability |
| Disciplinary process | CC1.5, CC5.2 | A.6.4 | Employee Descriptions; Sanction Policy |
...
| Human Resources Security | — | A.5.11, A.6.1, A.6.2, A.6.5, A.6.6 | Employee Verification; Employee Performance Evaluations |
| Information Classification | C1.1 | A.5.12, A.5.13 | Data Classification Review |
| Internal Audit & Management Review | CC4.1, CC4.2 | 9.1, 9.2, 9.3, 10.1, 10.2, A.5.35, A.8.34 | Internal Security Audit; Management Review Minutes |
| Legal, Regulatory & IP Compliance | — | 4.1, 4.2, A.5.31, A.5.32, A.5.33, A.5.34 | Legal Proof of Company Registration |
| Management Security Accountability | CC1.2, CC1.3 | 5.1, 6.2, 7.1, A.5.4 | Management Review Minutes |
...
| Personnel Security | CC1.1, CC1.4, CC1.5 | — | Employee Verification; Employee Performance Evaluations |
| Physical & Environmental Security | A1.2 | A.7.5, A.7.6, A.7.7, A.7.8, A.7.9, A.7.10, A.7.11, A.7.12, A.7.13, A.7.14 | Facility Security Plan |
...
| Policy Compliance | CC2.1, CC2.2, CC5.3 | 4.3, 4.4, 5.2, 7.4, 7.5.1, 7.5.2, 7.5.3, A.5.1, A.5.36 | Policy Documentation & Retention; Public Policies |
| Privileged & Production Access Restriction | CC6.1, CC6.2, CC6.3 | A.8.2, A.8.3, A.8.4, A.8.18 | Role-based Access Controls; Access Review Log |
| Regulatory Liaison | CC2.3 | A.5.5, A.5.6 | Contact Information |
| Remote-Work Security | CC6.6, CC6.7 | A.6.7 | Remote Access Review |
| Resource Capacity Management | A1.1 | A.8.6 | App Availability |
| Risk Management | CC3.1, CC3.2, CC3.3, CC3.4, CC9.1 | 6.1.1, 6.1.2, 6.1.3, 8.1, 8.2, 8.3 | Risk Analysis & Treatment Plan |
| Secure Data Transfer | C1.1, CC6.7, PI1.5 | A.5.14 | TLS / HTTPS |
| Secure SDLC Integration | CC8.1, PI1.1, PI1.2 | A.5.8, A.8.25, A.8.26, A.8.27, A.8.28, A.8.29, A.8.30, A.8.31, A.8.33 | Sanitized Inputs; Separation of Environments; Secure Code; Static Code Scanning |
...
| Security Logging | CC7.2 | A.8.15 | Audit Log Configuration & Retention |
| Security Monitoring & Detection | CC7.2, CC7.3 | A.5.7, A.8.16 | Monitoring & Alerting |
...
| Supplier Security | CC9.2 | A.5.19, A.5.20, A.5.21, A.5.22, A.5.23 | Supplier Evaluation Records; Vendor Register & Risk Tiering |
| System Description & Service Commitments | CC2.3 | — | Systems Description |
| Utility Tool monitoring | — | A.8.17, A.8.18 | Utility Monitoring |
