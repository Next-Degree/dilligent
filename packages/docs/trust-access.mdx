---
title: 'Trust Access'
description: 'Manage Trust Center access requests, NDAs, reviewer grants, audit trails, and shared compliance resources in Dilligent.'
---
...
<Note>
  Trust Access is API-backed across request intake, grant management, public Trust Center data, and
  reviewer workflows. Public organization automation should use API-key protected endpoints;
  reviewer session calls used by the Trust Portal app are intentionally omitted from the API
  reference.
</Note>
