...
description: 'Automatically answer vendor security questionnaires with approved policies, knowledge base documents, and Dilligent review workflows.'
---

<Note>
  For server-side automation, use the API-key protected questionnaire endpoints in the [API
  reference](/api-reference/questionnaire/upload-a-questionnaire-file-and-auto-answer-with-export).
</Note>
...
<Note>
  If you don't have published policies, you'll see an onboarding screen prompting you to publish
  policies first.
</Note>
