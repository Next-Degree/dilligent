...
description: "Connect Aikido to automate security evidence in Dilligent"
---

## Overview

The Aikido Security integration syncs vulnerability and repository scanning data into Dilligent, so compliance tasks can be automatically satisfied with continuous evidence.
...
1. Open the Aikido integration in Dilligent
