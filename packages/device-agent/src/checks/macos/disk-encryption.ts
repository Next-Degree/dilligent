      ...
      return {
        ...
        details: {
          ...
          message: isPermission
            ? 'Unable to determine FileVault status due to insufficient permissions. If your device is managed by an MDM, try granting Full Disk Access to the Dilligent Device Agent in System Settings > Privacy & Security.'
