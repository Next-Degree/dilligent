# Dilligent Device Agent -- Technical Specification
...
The Dilligent Device Agent is a custom Electron-based system tray application that replaces the previous FleetDM-based device compliance system.
