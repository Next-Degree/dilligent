...
export const Icons = {
  Logo: (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      role="img"
      aria-label="Dilligent"
      {...props}
    >
      <rect width={1254} height={1254} rx={200} fill="#D4F500" />
      <g transform="translate(0,1254) scale(0.1,-0.1)" fill="#052E23">
        <path d="M3200 10123 c-37 -14 -74 -49 -91 -87 -18 -39 -19 -90 -19 -1151 0 -698 4 -1123 10 -1144 13 -46 65 -99 110 -111 20 -6 197 -10 416 -10 371 0 382 -1 408 -21 52 -41 50 20 53 -1314 3 -1202 2 -1252 -16 -1291 -34 -74 -36 -74 -468 -74 -373 0 -379 0 -423 -22 -33 -17 -51 -35 -67 -68 l-23 -44 0 -1126 0 -1126 23 -44 c12 -25 37 -55 56 -67 l34 -23 2029 0 c2020 0 2030 0 2111 21 81 20 121 40 712 352 284 150 794 415 1097 571 272 140 291 152 348 212 78 84 87 103 171 361 39 120 137 421 219 668 82 248 198 601 259 785 60 184 142 434 182 555 l73 220 0 140 c0 134 -2 145 -38 255 -413 1270 -759 2299 -794 2360 -51 89 -125 149 -292 234 -196 100 -945 487 -1325 686 -462 241 -543 279 -620 295 -60 13 -363 15 -2095 14 -1114 0 -2032 -3 -2040 -6z m5278 -2266 c332 -332 354 -356 359 -395 3 -24 0 -55 -7 -72 -15 -37 -2794 -2808 -2829 -2821 -14 -6 -38 -7 -53 -3 -37 8 -1536 1507 -1556 1556 -28 66 -18 79 348 444 349 349 381 375 433 355 12 -5 186 -174 387 -375 363 -364 365 -366 406 -366 l42 0 1003 1011 c552 556 1013 1015 1024 1020 61 26 70 19 443 -354z" />
      </g>
    </svg>
  ),
  Overview: (props: any) => (
